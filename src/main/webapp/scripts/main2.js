...
function tutkiTiedot(){
	...
	}else if(document.getElementById("sposti").value.length<9||document.getElementById("sposti").value.indexOf(".")==-1||document.getElementById("sposti").value.indexOf("@")==-1){
